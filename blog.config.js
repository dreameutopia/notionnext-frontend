...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 当前主题，默认强制 heo
  
  // ============================================
  // 主题限制配置（新增）
  // ============================================
  ALLOWED_THEMES: ['heo', 'gitbook', 'typography'], // 允许的主题白名单
  ENABLE_THEME_SWITCH: process.env.NEXT_PUBLIC_ENABLE_THEME_SWITCH !== 'false', // 是否启用主题切换
